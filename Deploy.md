...
> 通过一个已有Ether的账户向新账户转帐.测试网的Ether可以通过每个测试网的水龙头申请到测试币.注意:`千万不要用新账户去申请测试币`,这样会使不同网络的nonce值不同.

- [获取测试币方法](https://github.com/Fankouzu/smart-contract/tree/master/Solidity Lesson 03#2获取ropsten测试币)
...
- [申请方法](https://github.com/Fankouzu/smart-contract/tree/master/Solidity Lesson 03#4注册infura获取测试网或主网的key)
